...
import { CodeDemo } from "@/components/ui/demo-components-animate-code";
...
export default function Home() {
  return (
    <div className="bg-black overflow-x-hidden">
      ...
      <section
        className="pt-28 sm:pt-32 relative min-h-screen grid grid-cols-1 lg:grid-cols-5
   px-4 sm:px-8 pb-20 overflow-hidden"
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <SectionHeading gray="Built forboth sidex" gold="of the table" />
        </div>
